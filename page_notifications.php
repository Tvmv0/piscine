                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a class="nav-link px-5" href="#">Notifications</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <?php
                        ...
                        if ($data['prix'] > $_SESSION['prix'])
                        {
                                echo "Le prix a augmenté pour l'item <a href="."page_produit.php?id=$id".">$item</a>";
                        }
                        else if ($data['prix'] < $_SESSION['prix'])
                        {
                                echo "Le prix a baissé pour l'item <a href="."page_produit.php?id=$id".">$item</a>";
                        }
                        else
                        {
                                echo "<center>Vous n'avez pas de notifications!</center>";
                        }
                    ?>
                </div>
            </div>
