    ...
    <div id="wrapper" class="container-fluid">
        ...
        <div class="container-fluid" id="section">
            <div class="container">
                ...
                <form class="square-form" action="inscription.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mail" placeholder="Entrez votre email" required>
                    </div>

                    <div class="form-group">
                        <label for="mdp">Mot de Passe :</label>
                        <input type="text" class="form-control" id="mdp" placeholder="Entrez votre mot de passe" required>
                    </div>
                    <br>
                    <p>Adresse : </p>
                    <div class="form-group">
                        <label for="num_rue">N° rue :</label>
                        <input type="int" class="form-control" id="num_rue" placeholder="Entrez le numero de la rue" required>
                    </div>
                    <div class="form-group">
                        <label for="nom_rue">Rue :</label>
                        <input type="text" class="form-control" id="nom_rue" placeholder="Entrez le nom de la rue" required>
                    </div>
                    <div class="form-group">
                        <label for="code_postal">Code postal :</label>
                        <input type="int" class="form-control" id="code_postal" placeholder="Entrez le code postal" required>
                    </div>
                    <div class="form-group">
                        <label for="ville">Ville :</label>
                        <input type="text" class="form-control" id="ville" placeholder="Entrez votre ville" required>
                    </div>
                    <div class="form-group">
                        <label for="ville">Pays :</label>
                        <input type="text" class="form-control" id="pays" placeholder="Entrez votre Pays" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="paiement">Information de Paiement :</label>
                        <input type="int" class="form-control" id="num_carte" placeholder="Entrez vos numéros de carte" required>
                        <!--<input type="date" class="form-control" id="date" placeholder="Entrez la date d'expiration" required>-->
                        <input type="int" class="form-control" id="num_cache" placeholder="CVV" required>
